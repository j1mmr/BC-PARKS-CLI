...
def get_coords(address):
    ...
    print(option2)
    print(option3)
    selection = int(input("Which address is correct? (1, 2, or 3):\t"))
...
def get_duration(startPoint, endPoint):
    ...
    return result["routes"][0]["summary"]["duration"] #returns duration in seconds
...
startPoint = get_coords(input("Enter starting address:\t"))
endPoint = get_coords(input("Enter ending address:\t"))
